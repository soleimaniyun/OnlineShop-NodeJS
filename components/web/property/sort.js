        ...
        <Box display="flex" alignItems="center" className={classes.frame}>
            ...
            >
                <ToggleButton value="favorite" aria-label="favorite">
                    <Typography className={classes.heading}>دیدگاه خریداران</Typography>
                </ToggleButton>
                <ToggleButton value="view" aria-label="view">
                    <Typography className={classes.heading}>نظرات کارشناسان</Typography>
                </ToggleButton>
                <ToggleButton value="expensive" aria-label="expensive">
                    <Typography className={classes.heading}>مفیدترین دیدگاه ها</Typography>
                </ToggleButton>
                <ToggleButton value="cheap" aria-label="cheap">
                    <Typography className={classes.heading}>جدیدترین دیدگاه ها</Typography>
                </ToggleButton>
            </ToggleButtonGroup>
        </Box>
        </NoSsr>
