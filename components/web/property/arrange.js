    ...
    return (
        ...
        <Box display="flex" alignItems="center" className={classes.frame}>
            <Box display="flex" className={classes.box}>
                ...
                <Typography className={classes.title}>مرتب سازی پرسش ها بر اساس : </Typography>
            </Box>
            <ToggleButtonGroup
            ...
            >
                <ToggleButton value="expensive" aria-label="expensive">
                    <Typography className={classes.heading}>مفیدترین پرسش ها</Typography>
                </ToggleButton>
                <ToggleButton value="cheap" aria-label="cheap">
                    <Typography className={classes.heading}>جدیدترین پرسش ها</Typography>
                </ToggleButton>
            </ToggleButtonGroup>
        </Box>
        </NoSsr>
