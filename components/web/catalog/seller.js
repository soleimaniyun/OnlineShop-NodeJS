            ...
            <Accordion>
                ...
                >
                    <div className={classes.div}>
                        <Typography className={classes.heading}>فروشندگان محصول</Typography>
                    </div>
                </AccordionSummary>
                                    ...
                                    <FormControlLabel
                                        ...
                                        label={
                                            <Box display="flex" justifyContent="space-between" className={classes.box}>
                                                <Typography className={classes.heading}>وب سایت لبخند</Typography>
                                                <Typography className={classes.heading}>Labkhand</Typography>
                                            </Box>
                                        }
                                    />
                                    <FormControlLabel
